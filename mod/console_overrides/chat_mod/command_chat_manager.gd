...
var COMMAND_REGISTRY: Dictionary = {
    ...
    "/wand": {"desc": "Show builder wand usage", "args": []},
    "/pos1": {"desc": "Set builder selection position 1", "args": ["[x y z]"]},
    "/pos2": {"desc": "Set builder selection position 2", "args": ["[x y z]"]},
    "/sel": {"desc": "Show builder selection", "args": []},
    "/fill": {"desc": "Fill selection with a block", "args": ["<block>"]},
    "/clear": {"desc": "Clear selection", "args": ["[water]"]},
    "/floor": {"desc": "Make a floor in selection", "args": ["<block>", "[y]"]},
    "/flat": {"desc": "Flatten chunks around player", "args": ["[radius_chunks]", "[block]", "[y]"]},
    "/border": {"desc": "Build world border wall", "args": ["[radius_chunks|block]", "[block|height]", "[height]"]},
    "/peaceful": {"desc": "Disable spawning and remove mobs", "args": ["[on|off]"]},
    "/daylock": {"desc": "Keep the world in daytime", "args": ["[on|off]"]},
    "/builder_setup": {"desc": "Creative, peaceful, day, flat spawn", "args": ["[radius_chunks]", "[block]", "[y]"]}
}
